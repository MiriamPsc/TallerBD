...
namespace AppMVCInstitutoJeffersonian.Controllers
{
    public class EquipoesController : Controller
    {
        ...
        {
            var equipo = db.Equipo.Include(e => e.Usuario).Include(e => e.Usuario1);
        ...
        public ActionResult Create([Bind(Include = "idEquipo,codigo,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idEquipo,codigo,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Equipo equipo)
        {
            if (ModelState.IsValid)
            {
